...
class _FullScreenImageViewerState extends State<FullScreenImageViewer> {
  ...
  void initState() {
    ...
    _index = widget.initialIndex
        .clamp(0, (widget.images.isNotEmpty ? widget.images.length - 1 : 0));
          ...
          children: <Widget>[
            hasImages
                ? PageView.builder(
                    ...
                    itemBuilder: (context, i) {
                      final url = AppConfig.sanitizeUrl(widget.images[i]);
                      return Container(
                        color: Colors.black,
            ...
            Positioned(
              ...
              child: Row(
                ...
                children:
                    List.generate(hasImages ? widget.images.length : 1, (i) {
